...
#' arguments \code{xlab}, \code{ylab}, \code{title}, \code{main},
#' \code{cex.main}, \code{mgp}, \code{cex.lab}, \code{cex.axis}, \code{ylim},
#' \code{xlim}, and \code{las} (see \code{\link{par}} on these), as well as
#' \code{plot.size}, \code{plot.unit}, \code{plot.ideo}, \code{ideo.frac},
#' \code{cyto.text}, \code{assembly} and \code{cex.cytotext} (see
#' \code{\link{plotSample}} on these). In addition, some other graphical
#' arguments specific for this plot function may be specified: \describe{
#' \item{list("col.gain")}{the color to be used for the gain frequencies,
#' default is "red".} \item{list("col.loss")}{the color to be used for the loss
#' frequencies, default is "blue".} \item{list("continuous")}{a logical value
#' indicating whether the probe frequencies should be presented as continuous,
#' i.e. the plotted probe frequency will start and end halfway between adjacent
#' probes (except across arms when chromosomes are plotted and except across
...
#' plotFreq(
#'   segments = seg, thres.gain = c(0.1, 0.2), thres.loss = c(-0.05, -0.1), chrom = c(1:23),
#'   layout = c(5, 5)
#' )
#'
#' @export
